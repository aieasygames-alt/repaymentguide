...
const faqs = [
  ...
  {
    question: 'How do I estimate student loan payments when married filing separately?',
    answer: 'Run both filing-status scenarios. Compare the borrower income used for IBR, PAYE, ICR, or RAP, then compare that payment difference against any added tax cost from filing separately.',
  },
];
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-12"><div className="mx-auto max-w-4xl space-y-8">
          ...
          <section className="rounded-3xl border bg-white p-6"><h2 className="text-2xl font-bold text-gray-900">Estimate payments for married filing separately</h2><p className="mt-3 text-gray-700">If one spouse earns about $42,000 or another specific income amount, do not estimate from household income alone. Run the borrower-only income scenario, then compare it with joint filing, RAP, IBR, PAYE, and PSLF assumptions.</p><div className="mt-5 grid gap-4 md:grid-cols-3"><Link href="/income-driven-repayment-calculator" className="rounded-2xl border bg-slate-50 p-5 font-semibold text-slate-900 hover:bg-slate-100">Compare IDR payments</Link><Link href="/income-based-repayment-calculator" className="rounded-2xl border bg-slate-50 p-5 font-semibold text-slate-900 hover:bg-slate-100">Estimate IBR</Link><Link href="/paye-payment-calculator" className="rounded-2xl border bg-slate-50 p-5 font-semibold text-slate-900 hover:bg-slate-100">Estimate PAYE</Link></div></section>
