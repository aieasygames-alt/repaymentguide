...
const blogPosts = [
  ...
  { slug: 'idr-payment-estimator-guide', lastModified: '2026-08-12' },
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const urls = [
    ...
    { url: `${baseUrl}/rap-payment-calculator/`, lastModified: '2026-09-01', changeFrequency: 'weekly' as const, priority: 0.9 },
    { url: `${baseUrl}/save-plan-calculator/`, lastModified: '2026-07-05', changeFrequency: 'weekly' as const, priority: 0.9 },
    { url: `${baseUrl}/income-driven-repayment-calculator/`, lastModified: '2026-09-01', changeFrequency: 'weekly' as const, priority: 0.9 },
    ...
    { url: `${baseUrl}/idr-payment-estimator/`, lastModified: '2026-09-01', changeFrequency: 'weekly' as const, priority: 0.86 },
    ...
    { url: `${baseUrl}/student-loan-payment-increase/`, lastModified: '2026-09-01', changeFrequency: 'monthly' as const, priority: 0.84 },
    { url: `${baseUrl}/servicer-contact-toolkit/`, lastModified: '2026-09-01', changeFrequency: 'monthly' as const, priority: 0.85 },
    ...
    { url: `${baseUrl}/save-90-day-deadline-calculator/`, lastModified: '2026-09-01', changeFrequency: 'weekly' as const, priority: 0.85 },
    ...
    { url: `${baseUrl}/married-filing-separately-student-loans-rap/`, lastModified: '2026-09-01', changeFrequency: 'monthly' as const, priority: 0.8 },
