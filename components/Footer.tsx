        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/news" className="text-gray-600 hover:text-primary-600">SAVE Plan Updates</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Free tools to help you navigate student loan repayment options and find the best plan for your situation.
            </p>
          </div>
        </div>
